...
equipment1 = MenuItem(name="shinguards", description="Pads that protect the players shins and ankles",
                     activity=activity1)
...
equipment2 = MenuItem(name="cleats", description="Allows the player to grip the grass to aid in sprinting and turning.",
                     activity=activity1)

session.add(equipment2)
session.commit()

equipment3 = MenuItem(name="soccer ball", description="A [multi]colored ball in the shape of a sphere",
                     activity=activity1)

session.add(equipment3)
session.commit()

equipment4 = MenuItem(name="goal", description="An opening in which a player attempts to kick the soccer ball into to score.",
                     activity=activity1)
...
activity1 = Activity(name="Basketball")
